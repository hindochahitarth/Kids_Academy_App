...
import 'package:finalprjct1/pear.dart';
...
class Sapota extends StatefulWidget{

  @override
  State<Sapota> createState() => _SapotaState();
}

class _SapotaState extends State<Sapota> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/General Awarness/Fruits/sapota.mp3'),    autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
               image: AssetImage('assets/General Awarness/Fruits/sapota.png'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('SAPOTA',style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold,letterSpacing: 2,),),
          ...
          Positioned(top: 335,left: 730,child: TextButton.icon(onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Pear()));
            assetsAudioPlayer.stop();
          },
