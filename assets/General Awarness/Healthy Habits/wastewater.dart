...
import 'package:finalprjct1/light.dart';
...
class Wastewater extends StatefulWidget{

  @override
  State <Wastewater> createState() => _WastewaterState();
}

class _WastewaterState extends State<Wastewater> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/General Awarness/Healthy Habits/wastewater.mp3'),  autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Healthy Habits/wastewater.png'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(top: 335,left: 730,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Haction()));
          },
