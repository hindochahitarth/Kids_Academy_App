...
import 'package:finalprjct1/truck.dart';
...
class _BusState extends State<Bus> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      Audio('assets/General Awarness/Transport/Roadways/bus.mp3'), autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Transport/Roadways/bus.png'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('BUS',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold,letterSpacing: 3,),),
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Truck()));
          },
