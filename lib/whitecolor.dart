...
import 'package:finalprjct1/blackcolor.dart';
...
import 'browncolor.dart';
import 'graycolor.dart';
import 'greencolor.dart';
import 'home.dart';
import 'orangecolor.dart';

class WhiteColor extends StatefulWidget{

  @override
  State<WhiteColor> createState() => _SeasonState();
}

class _SeasonState extends State<WhiteColor> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Colors/white.jpg'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('WHITE',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
        ...
        Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
              assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>BlackColor()));
          },
         ...
         Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
             assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>BrownColor()));
          },
