...
class Opt6 extends StatefulWidget {
  @override
  _Opt6State createState() => _Opt6State();
}

class _Opt6State extends State<Opt6> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false];
  List<String> audioFiles = [

    'assets/Maths/Operators/equal.mp3',
    'assets/Maths/Operators/10.mp3',
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(top: 185,left: 15,       child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Opt5()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 47,color: Colors.limeAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
