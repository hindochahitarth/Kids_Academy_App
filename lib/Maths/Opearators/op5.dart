...
class Opt5 extends StatefulWidget {
  @override
  _Opt5State createState() => _Opt5State();
}

class _Opt5State extends State<Opt5> {
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 47,color: Colors.deepOrange,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
