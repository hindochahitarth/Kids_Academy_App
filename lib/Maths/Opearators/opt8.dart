...
import 'package:finalprjct1/Maths/Opearators/opt7.dart';
import 'package:finalprjct1/Maths/Opearators/opt9.dart';
import 'package:finalprjct1/Maths/Subtraction/sub7.dart';import '../mathscategory.dart';

import 'package:flutter/material.dart';

class Opt8 extends StatefulWidget {
  @override
  _Opt8State createState() => _Opt8State();
}

class _Opt8State extends State<Opt8> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false];
  List<String> audioFiles = [

    'assets/Maths/Operators/greater.mp3',
    'assets/Maths/Operators/9.mp3',
  ...
  Widget build(BuildContext context) {
         ...
         backgroundColor:Colors.black
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Opt9()));
                audioPlayer.stop();
                audioPlayer.stop();
   ...
   Positioned(top: 185,left: 15,       child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Opt7()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 47,color: Colors.lightGreenAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
