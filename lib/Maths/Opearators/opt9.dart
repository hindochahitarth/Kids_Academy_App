...
class Opt9 extends StatefulWidget {
  @override
  _Opt9State createState() => _Opt9State();
}

class _Opt9State extends State<Opt9> {
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 47,color: Colors.deepOrangeAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
