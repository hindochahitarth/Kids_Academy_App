...
import 'package:finalprjct1/Maths/Shapes/kite.dart';
...
class _HexagonState extends State<Hexagon> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      Audio('assets/Maths/Shapes/hexagon.mp3'),
      autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 185,
            child: InkWell(
              ...
              child: Image(
                image: AssetImage('assets/Maths/Shapes/hexagon.jpg'),
                height: 320,
                width: 480,
                fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('HEXAGON',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
           ...
           Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
                assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Kite()));
          },
