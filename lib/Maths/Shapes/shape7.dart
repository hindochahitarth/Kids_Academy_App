...
class _RhombusState extends State<Rhombus> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      Audio('assets/Maths/Shapes/rhombus.mp3'),
      autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 185,
            child: InkWell(
              ...
              child: Image(
                image: AssetImage('assets/Maths/Shapes/rhombus.jpg'),
                height: 350,
                width: 480,
                fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('RHOMBUS',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
           ...
           Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
                assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Star()));
          },
