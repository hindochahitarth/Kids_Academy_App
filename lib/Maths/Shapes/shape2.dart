...
class _RectangleState extends State<Rectangle> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      Audio('assets/Maths/Shapes/rectangle.mp3'),
      autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 185,
            child: InkWell(
              ...
              child: Image(
                image: AssetImage('assets/Maths/Shapes/rectangle.jpg'),
                height: 350,
                width: 480,
                fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('RECTANGLE',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
