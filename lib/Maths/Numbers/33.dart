...
import 'package:finalprjct1/Maths/Numbers/32.dart';
import 'package:finalprjct1/Maths/Numbers/34.dart';
...
class Th3 extends StatefulWidget {
  @override
  _Th3State createState() => _Th3State();
}

class _Th3State extends State<Th3> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/33.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th4()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              left: 20, child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th2()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
