...
import 'package:finalprjct1/Maths/Numbers/49.dart';
import '51.dart';
...
class Fi0 extends StatefulWidget {
  @override
  _Fi0State createState() => _Fi0State();
}

class _Fi0State extends State<Fi0> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/1.mp3',
