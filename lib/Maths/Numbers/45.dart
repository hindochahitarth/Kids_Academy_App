...
import 'package:finalprjct1/Maths/Numbers/44.dart';
import '46.dart';
...
class Fo5 extends StatefulWidget {
  @override
  _Fo5State createState() => _Fo5State();
}

class _Fo5State extends State<Fo5> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/45.mp3',
  ...
  Widget build(BuildContext context) {
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Fo4()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
