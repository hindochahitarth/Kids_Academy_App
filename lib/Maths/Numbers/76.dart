...
import 'package:finalprjct1/Maths/Numbers/75.dart';
import '77.dart';
...
class Se6 extends StatefulWidget {
  @override
  _Se6State createState() => _Se6State();
}

class _Se6State extends State<Se6> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/76.mp3',
  ...
  Widget build(BuildContext context) {
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Se5()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
