...
import 'package:finalprjct1/Maths/Numbers/3.dart';
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Five()));
                audioPlayer.stop();
                audioPlayer.stop();
           ...
           Positioned(
              bottom: 20, // Adjust position as needed
               left: 20, child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Three()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
