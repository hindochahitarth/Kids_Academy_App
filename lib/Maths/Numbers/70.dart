...
class Se0 extends StatefulWidget {
  @override
  _Se0State createState() => _Se0State();
}

class _Se0State extends State<Se0> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/70.mp3',
