...
import 'package:finalprjct1/Maths/Numbers/27.dart';
import 'package:finalprjct1/Maths/Numbers/29.dart';
...
class Twentyeight extends StatefulWidget {
  @override
  TwentyeightState createState() => TwentyeightState();
}

class TwentyeightState extends State<Twentyeight> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/28.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Twentynine()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              left: 20,  child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Twentyseven()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
