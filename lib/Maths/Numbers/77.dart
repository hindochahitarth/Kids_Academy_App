...
import 'package:finalprjct1/Maths/Numbers/76.dart';
import '78.dart';
...
class Se7 extends StatefulWidget {
  @override
  _Se7State createState() => _Se7State();
}

class _Se7State extends State<Se7> {
  ...
  Widget build(BuildContext context) {
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Se6()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
