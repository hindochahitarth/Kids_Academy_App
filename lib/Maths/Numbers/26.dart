...
import 'package:finalprjct1/Maths/Numbers/25.dart';
...
class Twentysix extends StatefulWidget {
  @override
  TwentysixState createState() => TwentysixState();
}

class TwentysixState extends State<Twentysix> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/26.mp3',
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              left: 20, child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Twentyfive()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
