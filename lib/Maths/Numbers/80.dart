...
import 'package:finalprjct1/Maths/Numbers/69.dart';
import '71.dart';
...
class Ei0 extends StatefulWidget {
  @override
  _Ei0State createState() => _Ei0State();
}

class _Ei0State extends State<Ei0> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/80.mp3',
    'assets/English/Alphabets/e.mp3',

    'assets/English/Alphabets/i.mp3',
    'assets/English/Alphabets/vg.mp3',
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Ei1()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Si9()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
