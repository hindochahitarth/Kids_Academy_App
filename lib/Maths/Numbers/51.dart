...
import 'package:finalprjct1/Maths/Numbers/40.dart';
import 'package:finalprjct1/Maths/Numbers/41.dart';
import '50.dart';
import '52.dart';
...
class Fi1 extends StatefulWidget {
  @override
  _Fi1State createState() => _Fi1State();
}

class _Fi1State extends State<Fi1> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/51.mp3',
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Fi2()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Fi0()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
