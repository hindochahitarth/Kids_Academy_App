...
class Ei5 extends StatefulWidget {
  @override
  _Ei5State createState() => _Ei5State();
}

class _Ei5State extends State<Ei5> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false, false, false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/85.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Ei6()));
                audioPlayer.stop();
                audioPlayer.stop();
