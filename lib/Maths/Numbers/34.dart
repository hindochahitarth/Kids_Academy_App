...
import 'package:finalprjct1/Maths/Numbers/35.dart';
...
class Th4 extends StatefulWidget {
  @override
  _Th4State createState() => _Th4State();
}

class _Th4State extends State<Th4> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/34.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th5()));
                audioPlayer.stop();
                audioPlayer.stop();
