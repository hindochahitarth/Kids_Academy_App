...
import 'package:finalprjct1/Maths/Numbers/72.dart';
import '74.dart';
...
class Se3 extends StatefulWidget {
  @override
  _Se3State createState() => _Se3State();
}

class _Se3State extends State<Se3> {
  ...
  Widget build(BuildContext context) {
    ...
    //   size: 160.0, // Set the desired size for Button 4
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Se4()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Se2()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
