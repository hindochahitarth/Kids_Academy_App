...
class Th7 extends StatefulWidget {
  @override
  _Th7State createState() => _Th7State();
}

class _Th7State extends State<Th7> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/37.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th8()));
                audioPlayer.stop();
                audioPlayer.stop();
