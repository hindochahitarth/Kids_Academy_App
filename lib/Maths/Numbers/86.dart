...
class Ei6 extends StatefulWidget {
  @override
  _Ei6State createState() => _Ei6State();
}

class _Ei6State extends State<Ei6> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/86.mp3',
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Ei7()));
                audioPlayer.stop();
                audioPlayer.stop();
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Ei5()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
