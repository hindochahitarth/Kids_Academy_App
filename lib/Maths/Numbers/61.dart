...
import 'package:finalprjct1/Maths/Numbers/60.dart';
import '62.dart';
...
class Si1 extends StatefulWidget {
  @override
  _Si1State createState() => _Si1State();
}

class _Si1State extends State<Si1> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/61.mp3',
  ...
  Widget build(BuildContext context) {
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Si0()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
