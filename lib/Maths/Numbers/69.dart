...
import 'package:finalprjct1/Maths/Numbers/68.dart';
import '70.dart';
...
class Si9 extends StatefulWidget {
  @override
  _Si9State createState() => _Si9State();
}

class _Si9State extends State<Si9> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/69.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Se0()));
                audioPlayer.stop();
                audioPlayer.stop();
