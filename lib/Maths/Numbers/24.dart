...
import 'package:finalprjct1/Maths/Numbers/23.dart';
...
class Twentyfour extends StatefulWidget {
  @override
  _TwentyfourState createState() => _TwentyfourState();
}
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              left: 20,  child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Twentythree()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
