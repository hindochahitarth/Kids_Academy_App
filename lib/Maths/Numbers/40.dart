...
import 'package:finalprjct1/Maths/Numbers/39.dart';
import '41.dart';
...
class Fo0 extends StatefulWidget {
  @override
  _Fo0State createState() => _Fo0State();
}

class _Fo0State extends State<Fo0> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/40.mp3',
    ...
    label: Text('',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
          ...
          Positioned(
              ...
              left: 20, child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th9()));
                audioPlayer.stop();
                audioPlayer.stop();
                audioPlayer.stop();audioPlayer.stop();audioPlayer.stop();
