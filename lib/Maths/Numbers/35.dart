...
import 'package:finalprjct1/Maths/Numbers/36.dart';
...
class Th5 extends StatefulWidget {
  @override
  _Th5State createState() => _Th5State();
}

class _Th5State extends State<Th5> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false,false,false, false, false, false,false,false,false];
  List<String> audioFiles = [
    'assets/Maths/Numbers/35.mp3',
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Th6()));
                audioPlayer.stop();
                audioPlayer.stop();
