...
import 'package:finalprjct1/Maths/Addition/addition13.dart';
...
class Addition12 extends StatefulWidget{
  @override
  State<Addition12> createState() => _Addition12State();
}

class _Addition12State extends State<Addition12> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Additon/6.mp3',
    'assets/Maths/Additon/plus.mp3',
    'assets/Maths/Additon/6.mp3',
    'assets/Maths/Additon/equal.mp3',
    'assets/Maths/Additon/12.mp3',
  ];
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition11()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.red,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
