...
class Addition9 extends StatefulWidget{
  @override
  State<Addition9> createState() => _Addition9State();
}

class _Addition9State extends State<Addition9> {
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.deepPurpleAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
