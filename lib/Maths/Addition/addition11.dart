...
class Addition11 extends StatefulWidget{
  @override
  State<Addition11> createState() => _Addition11State();
}

class _Addition11State extends State<Addition11> {
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(top: 335,left: 750, // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition12()));
                audioPlayer.stop();
                audioPlayer.stop();
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition10()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.yellow,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
