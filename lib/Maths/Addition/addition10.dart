...
class Addition10 extends StatefulWidget{
  @override
  State<Addition10> createState() => _Addition10State();
}

class _Addition10State extends State<Addition10> {
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition9()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.pinkAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
