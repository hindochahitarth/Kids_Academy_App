...
class Addition2 extends StatefulWidget{
  @override
  State<Addition2> createState() => _Addition2State();
}
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.amberAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
