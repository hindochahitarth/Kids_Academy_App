...
import 'package:finalprjct1/Maths/Addition/addition18.dart';
...
class Addition17 extends StatefulWidget{
  @override
  State<Addition17> createState() => _Addition17State();
}

class _Addition17State extends State<Addition17> {
        ...
        children: <Widget>[
          ...
          Positioned(top: 335,left: 750, // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition18()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.white,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
