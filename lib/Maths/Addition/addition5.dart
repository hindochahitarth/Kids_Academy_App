...
class Addition5 extends StatefulWidget{
  @override
  State<Addition5> createState() => _Addition5State();
}

class _Addition5State extends State<Addition5> {
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition4()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.greenAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
