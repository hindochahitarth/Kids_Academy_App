...
import 'addition9.dart';

class Addition8 extends StatefulWidget{
  @override
  State<Addition8> createState() => _Addition8State();
}

class _Addition8State extends State<Addition8> {
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition7()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.redAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
