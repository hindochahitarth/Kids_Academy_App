...
import 'package:finalprjct1/Maths/Addition/addition10.dart';
import 'package:finalprjct1/Maths/Addition/addition11.dart';
import 'package:finalprjct1/Maths/Addition/addition12.dart';
...
import 'package:finalprjct1/Maths/Addition/addition9.dart';
...
class Addition14 extends StatefulWidget{
  @override
  State<Addition14> createState() => _Addition14State();
}

class _Addition14State extends State<Addition14> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Additon/7.mp3',
    'assets/Maths/Additon/plus.mp3',
    'assets/Maths/Additon/7.mp3',
    'assets/Maths/Additon/equal.mp3',
    'assets/Maths/Additon/14.mp3',
  ];
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(top: 335,left: 750, // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition15()));
                audioPlayer.stop();
                audioPlayer.stop();
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition13()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.cyanAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
