...
class Addition4 extends StatefulWidget{
  @override
  State<Addition4> createState() => _Addition4State();
}

class _Addition4State extends State<Addition4> {
  ...
  Widget build(BuildContext context) {
        ...
        children: <Widget>[
          ...
          Positioned(top: 335,left: 750, // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition5()));
                audioPlayer.stop();
                audioPlayer.stop();
   ...
   Positioned(top: 335,left: 15,   // Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Addition3()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.lightGreenAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
