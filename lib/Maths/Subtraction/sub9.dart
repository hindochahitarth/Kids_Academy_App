...
import 'package:finalprjct1/Maths/Subtraction/sub10.dart';
          ...
          Positioned(
            ...
            child: AnimatedButton(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Sub10()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              onPressed: onPressed,
              style: TextButton.styleFrom(),
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.tealAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
