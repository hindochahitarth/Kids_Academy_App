...
class _Sub2State extends State<Sub2> {
  ...
  List<String> audioFiles = [
    ...
    'assets/Maths/Subtraction/0.mp3',
  ];
  @override
  void initState() {
    super.initState();
          ...
          Positioned(
            ...
            child: AnimatedButton(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Sub3()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              onPressed: onPressed,
              style: TextButton.styleFrom(),
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.deepOrange,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
