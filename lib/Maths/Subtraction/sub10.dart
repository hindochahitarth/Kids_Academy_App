...
import 'package:finalprjct1/Maths/Subtraction/sub9.dart';
import 'package:flutter/material.dart';

class Sub10 extends StatefulWidget {
  @override
  _Sub10State createState() => _Sub10State();
}

class _Sub10State extends State<Sub10> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Subtraction/9.mp3',
          ...
          Positioned(
            ...
            child: AnimatedButton(
              ...
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Sub9()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              onPressed: onPressed,
              style: TextButton.styleFrom(),
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.indigoAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
