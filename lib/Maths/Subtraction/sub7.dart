...
import 'package:finalprjct1/Maths/Subtraction/sub6.dart';
import 'package:finalprjct1/Maths/Subtraction/sub8.dart';
import 'package:flutter/material.dart';

class Sub7 extends StatefulWidget {
  @override
  _Sub7State createState() => _Sub7State();
}

class _Sub7State extends State<Sub7> {
  final AssetsAudioPlayer audioPlayer = AssetsAudioPlayer();
  List<bool> buttonVisibility = [false, false, false, false, false];
  List<String> audioFiles = [
    'assets/Maths/Subtraction/10.mp3',
    'assets/Maths/Subtraction/minus.mp3',
    'assets/Maths/Subtraction/5.mp3',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          ...
          ),Positioned(top: 345,left: 770,// Adjust position as needed
              child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Sub8()));
                audioPlayer.stop();
                audioPlayer.stop();
   ...
   Positioned(top: 345,left: 15,     child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Sub6()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              onPressed: onPressed,
              style: TextButton.styleFrom(),
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 45,color: Colors.orangeAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
