...
class OrangeColor extends StatefulWidget{

  @override
  State<OrangeColor> createState() => _SeasonState();
}

class _SeasonState extends State<OrangeColor> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Colors/orange.jpg'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('ORANGE',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
           ...
           Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>RedColor()));
          },
