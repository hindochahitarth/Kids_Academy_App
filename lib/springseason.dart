...
class SpringSeason extends StatefulWidget{
  ...
  @override
  State<SpringSeason> createState() => _SeasonState();
}

class _SeasonState extends State<SpringSeason> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Seasons/spring.jpg'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
