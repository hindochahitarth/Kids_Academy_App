...
class RoadWays extends StatefulWidget {
  @override
  State<RoadWays> createState() => _RoadWaysState();
}

class _RoadWaysState extends State<RoadWays> {
  @override
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/General Awarness/Transport/Roadways/bike.mp3'),     autoStart: true,
        ...
        Stack(
          ...
          children: [
            ...
            Positioned(top: 35,left: 190,
              child: Image(
                image: AssetImage('assets/General Awarness/Transport/Roadways/bike.png'),
                height: 290,
                width: 450,
                fit: BoxFit.fill,
            ...
            Positioned(child: TextButton(onPressed: () {
              ...
              child: Text('BIKE',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
