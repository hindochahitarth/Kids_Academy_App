...
import 'package:finalprjct1/English/Rhyming%20Words/ryhm8.dart';
...
class Rhym7 extends StatefulWidget{

  @override
  State <Rhym7> createState() => _Rhym7State();
}

class _Rhym7State extends State<Rhym7> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 75,left: 60,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/cake_2_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(top: 75,left: 460,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/lake_15_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('CAKE',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('LAKE',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            //         style: TextButton.styleFrom(elevation: 20,
            //             shadowColor: Colors.brown,
            //             backgroundColor: Colors.blue,
            //           //  shape: StadiumBorder()
          ...
          Positioned(top: 330,left: 770,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Rhym8()));
          },
