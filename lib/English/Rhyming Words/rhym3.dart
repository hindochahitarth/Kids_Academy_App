...
class Rhym3 extends StatefulWidget{

  @override
  State <Rhym3> createState() => _Rhym3State();
}

class _Rhym3State extends State<Rhym3> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 75,left: 60,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/cut_5_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(top: 75,left: 460,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/hut_14_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('CUT',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('HUT',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            //         style: TextButton.styleFrom(elevation: 20,
            //             shadowColor: Colors.brown,
            //             backgroundColor: Colors.blue,
            //           //  shape: StadiumBorder()
