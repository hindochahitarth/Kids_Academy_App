...
import 'package:finalprjct1/English/Rhyming%20Words/ryhm9.dart';
...
class Rhym8 extends StatefulWidget{

  @override
  State <Rhym8> createState() => _Rhym8State();
}

class _Rhym8State extends State<Rhym8> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 75,left: 60,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/floor_8_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(top: 75,left: 460,
            child: Image(
              image: AssetImage('assets/English/Rhyming word/11zon_resized/four_9_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('FLOOR',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('FOUR',style: TextStyle(color: Colors.black,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            //         style: TextButton.styleFrom(elevation: 20,
            //             shadowColor: Colors.brown,
            //             backgroundColor: Colors.blue,
            //           //  shape: StadiumBorder()
          ...
          Positioned(top: 330,left: 770,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Rhym9()));
          },
