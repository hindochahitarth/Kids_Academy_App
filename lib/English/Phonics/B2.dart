...
import 'package:finalprjct1/English/Phonics/B3.dart';
import 'package:finalprjct1/English/Phonics/C1.dart';
...
class _B2State extends State<B2> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/English/Phonics/bball.mp3'),    autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 330,
            child: Image(
              image: AssetImage('assets/English/Phonics/ball.jpg'),
              height: 290,
              width: 350,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('B',style: TextStyle(color: Colors.blue,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
          ...
          Positioned(top: 180,left: 740,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>B3()));
          },
          ...
          Positioned(top: 345,left: 770,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>C1()));
          },
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('B for Ball',style: TextStyle(color: Colors.blue,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            // style: TextButton.styleFrom(elevation: 20,
            //     shadowColor: Colors.brown,
            //     backgroundColor: Colors.blue,
            //     shape: StadiumBorder()),
