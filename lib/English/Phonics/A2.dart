...
class _A2State extends State<A2> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/English/Phonics/aaeroplane.mp3'),    autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 180,left: 740,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>A3()));
          },
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('A for aeroplane',style: TextStyle(color: Colors.blue,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
