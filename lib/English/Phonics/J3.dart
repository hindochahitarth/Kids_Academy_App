...
class _J3State extends State<J3> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/English/Phonics/jjeep.mp3'),    autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 330,
            child: Image(
              image: AssetImage('assets/English/Phonics/jeep.png'),
              height: 290,
              width: 350,
              fit: BoxFit.fill,
          ...
          Positioned(top: 180,left: 30,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>J2()));
          },
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('J for Jeep',style: TextStyle(color: Colors.blue,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            // style: TextButton.styleFrom(elevation: 20,
            //     shadowColor: Colors.brown,
            //     backgroundColor: Colors.blue,
            //     shape: StadiumBorder()),
