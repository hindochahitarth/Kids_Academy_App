...
class _G2State extends State<G2> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/English/Phonics/ggrapes.mp3'),    autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(
           top: 35,left: 330,
            child: Image(
              image: AssetImage('assets/English/Phonics/grapes.png'),
              height: 290,
              width: 350,
              fit: BoxFit.fill,
          ...
          Positioned(top: 180,left: 740,child: TextButton.icon(onPressed: (){
            assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>G3()));
          },
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('G for Grapes',style: TextStyle(color: Colors.blue,fontSize: 40,fontWeight: FontWeight.bold,letterSpacing: 2,),),
            // style: TextButton.styleFrom(elevation: 20,
            //     shadowColor: Colors.brown,
            //     backgroundColor: Colors.blue,
            //     shape: StadiumBorder()),
