...
import 'package:finalprjct1/English/Alphabet/k.dart';
...
class Alphal extends StatefulWidget{
  @override
  State<Alphal> createState() => _AlphalState();
}

class _AlphalState extends State<Alphal> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphak()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.purpleAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
