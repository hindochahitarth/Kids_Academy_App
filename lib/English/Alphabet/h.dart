...
import 'package:finalprjct1/English/Alphabet/g.dart';
...
class Alphah extends StatefulWidget{
  @override
  State<Alphah> createState() => _AlphahState();
}

class _AlphahState extends State<Alphah> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphag()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.pink,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
