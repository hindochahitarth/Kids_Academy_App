...
import 'package:finalprjct1/English/Alphabet/l.dart';
...
class Alphak extends StatefulWidget{
  @override
  State<Alphak> createState() => _AlphakState();
}

class _AlphakState extends State<Alphak> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphal()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.cyanAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
