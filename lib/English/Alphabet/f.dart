...
class Alphaf extends StatefulWidget{
  @override
  State<Alphaf> createState() => _AlphafState();
}

class _AlphafState extends State<Alphaf> {
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.amber,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
