...
import 'package:finalprjct1/English/Alphabet/n.dart';
...
class Alpham extends StatefulWidget{
  @override
  State<Alpham> createState() => _AlphamState();
}

class _AlphamState extends State<Alpham> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphan()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.brown,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
