...
import 'package:finalprjct1/English/Alphabet/t.dart';
import 'package:finalprjct1/English/Alphabet/v.dart';
...
class Alphau extends StatefulWidget{
  @override
  State<Alphau> createState() => _AlphauState();
}

class _AlphauState extends State<Alphau> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphav()));
                audioPlayer.stop();
                audioPlayer.stop();
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphat()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.limeAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
