...
import 'package:finalprjct1/English/Alphabet/p.dart';
import 'package:finalprjct1/English/Alphabet/r.dart';
...
class Alphaq extends StatefulWidget{
  @override
  State<Alphaq> createState() => _AlphaqState();
}

class _AlphaqState extends State<Alphaq> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphar()));
                audioPlayer.stop();
                audioPlayer.stop();
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphap()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.tealAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
