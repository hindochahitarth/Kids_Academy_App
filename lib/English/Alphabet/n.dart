...
import 'package:finalprjct1/English/Alphabet/m.dart';
import 'package:finalprjct1/English/Alphabet/o.dart';
...
class Alphan extends StatefulWidget{
  @override
  State<Alphan> createState() => _AlphanState();
}

class _AlphanState extends State<Alphan> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphao()));
                audioPlayer.stop();
                audioPlayer.stop();
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alpham()));
                audioPlayer.stop();
