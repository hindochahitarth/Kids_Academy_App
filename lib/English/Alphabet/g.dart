...
class Alphag extends StatefulWidget{
  @override
  State<Alphag> createState() => _AlphagState();
}

class _AlphagState extends State<Alphag> {
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.redAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
