...
import 'package:finalprjct1/English/Alphabet/y.dart';
...
class Alphax extends StatefulWidget{
  @override
  State<Alphax> createState() => _AlphaxState();
}

class _AlphaxState extends State<Alphax> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphay()));
                audioPlayer.stop();
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.blue,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
