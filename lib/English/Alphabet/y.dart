...
import 'package:finalprjct1/English/Alphabet/x.dart';
import 'package:finalprjct1/English/Alphabet/z.dart';
...
class Alphay extends StatefulWidget{
  @override
  State<Alphay> createState() => _AlphayState();
}

class _AlphayState extends State<Alphay> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphaz()));
                audioPlayer.stop();
                audioPlayer.stop();
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphax()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.lightGreenAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
