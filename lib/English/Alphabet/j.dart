...
import 'package:finalprjct1/English/Alphabet/i.dart';
...
class Alphaj extends StatefulWidget{
  @override
  State<Alphaj> createState() => _AlphajState();
}

class _AlphajState extends State<Alphaj> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphai()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.lime,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
