...
import 'package:finalprjct1/English/Alphabet/h.dart';
import 'package:finalprjct1/English/Alphabet/j.dart';
...
class Alphai extends StatefulWidget{
  @override
  State<Alphai> createState() => _AlphaiState();
}

class _AlphaiState extends State<Alphai> {
  ...
  Positioned(top: 5,left: 5,child: ElevatedButton.icon(onPressed: (){
         ...
         Positioned(
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphaj()));
                audioPlayer.stop();
                audioPlayer.stop();
          ...
          Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Alphah()));
                audioPlayer.stop();
        ...
        children: [
          Positioned(
            ...
            child: TextButton(
              ...
              child: Text(label,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 55,color: Colors.blueAccent,letterSpacing: 2,)),
            ),
          ),
          SizedBox(height: 10),
        ],
