...
import 'package:finalprjct1/English/Articles/the2.dart';
...
class Articlethe1 extends StatefulWidget{

  @override
  State <Articlethe1> createState() => _Articlethe1State();
}

class _Articlethe1State extends State<Articlethe1> {
  @override
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 75,left: 60,
            child: Image(
              image: AssetImage('assets/English/Articles/The/images/moon_2_11zon.jpg'),
              height: 230,
              width: 300,
              fit: BoxFit.fill,
          ...
          Positioned(top: 115,left: 385,
            child: Image(
              image: AssetImage('assets/English/Articles/The/images/rain_3_11zon.jpg'),
              height: 140,
              width: 150,
              fit: BoxFit.fill,
          ...
          Positioned(top: 75,left: 600,
            child: Image(
              image: AssetImage('assets/English/Articles/The/images/water_6_11zon.jpg'),
              height: 230,
              width: 200,
              fit: BoxFit.fill,
          ...
          Positioned(child: Text('moon',style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold),),top: 320,left: 185),
          Positioned(child: Text('The',style: TextStyle(color: Colors.blue,fontSize: 30,fontWeight: FontWeight.bold),),top: 320,left: 420,),

          Positioned(child: Text('rain',style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold),),top: 320,left: 475),

          Positioned(child: Text('The',style: TextStyle(color: Colors.blue,fontSize: 30,fontWeight: FontWeight.bold),),top: 320,left: 660,),

          Positioned(child: Text('water',style: TextStyle(color: Colors.black,fontSize: 30,fontWeight: FontWeight.bold),),top: 320,left: 715,),

          Positioned(top: 330,left: 770,child: TextButton.icon(onPressed: (){
            // assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>ArticleThe2()));
          },
