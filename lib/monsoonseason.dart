...
class MonsoonSeason extends StatefulWidget{

  @override
  State <MonsoonSeason> createState() => _SeasonState();
}

class _SeasonState extends State<MonsoonSeason> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Seasons/rain.jpg'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SummerSeason()));
          },
