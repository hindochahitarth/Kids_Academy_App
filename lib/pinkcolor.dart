...
class PinkColor extends StatefulWidget{

  @override
  State<PinkColor> createState() => _SeasonState();
}

class _SeasonState extends State<PinkColor> {
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
              image: AssetImage('assets/General Awarness/Colors/pink.jpg'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('PINK',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold,letterSpacing: 3,),),
          ...
          Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>GreenColor()));
          },
           ...
           Positioned(top: 185,left: 15,child: TextButton.icon(onPressed: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>OrangeColor()));
          },
