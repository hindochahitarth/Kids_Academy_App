...
class SweetLime extends StatefulWidget{

  @override
  State <SweetLime> createState() => _SweetLimeState();
}

class _SweetLimeState extends State<SweetLime> {
  ...
  Future<void> playMusic() async {
    await assetsAudioPlayer.open(
      ...
      Audio('assets/General Awarness/Fruits/sweetlime.mp3'), autoStart: true,
      ...
      Stack(
        ...
        children: [
          ...
          Positioned(top: 35,left: 190,
            child: Image(
               image: AssetImage('assets/General Awarness/Fruits/sweetlime.png'),
              height: 290,
              width: 450,
              fit: BoxFit.fill,
          ...
          Positioned(child: TextButton(onPressed: () {
            ...
            child: Text('SWEETLIME',style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold,letterSpacing: 2,),),
        ...
        Positioned(top: 185,left: 770,child: TextButton.icon(onPressed: (){
              assetsAudioPlayer.stop();
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Mango()));
          },
